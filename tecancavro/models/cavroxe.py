'''
tecancavro.models.cavroxe

Class-based interface to Tecan Cavro XE syringe pumps
...
class CavroXE(Syringe):
    '''
    Class to control CavroXE pumps with distribution valves. Provides front-
