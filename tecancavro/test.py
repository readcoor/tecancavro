from models import XECavro
from transport import TecanAPISerial, TecanAPINode
from inspect import stack
import traceback

# Functions to return instantiated XCaliburD objects for testing
def returnSerialXECavro():
	#A505H00P
	#A505H00Q
    obj = XECavro(com_link=TecanAPISerial(0, '/dev/cu.usbserial-A505H00Q', 9600))
    return obj
...
'''
print "initLeftPort"
xecavro.initLeftPort()
delay = xecavro.executeChain()
xecavro.waitReady(delay)
'''
